...
BoneGene::BoneGene(const int numNodes, const Genome& genome): connection(getGoodConnection(numNodes, genome)) {}
BoneGene::BoneGene(const int a, const int b): BoneGene(Connection(a, b)) {}
BoneGene::BoneGene(const Connection c): connection(c) {}
BoneGene::BoneGene(const BoneGene& other) : Gene(other), connection(other.connection) {}
BoneGene::BoneGene(const std::string representation) : connection(-1, -1) {
...
Connection BoneGene::getGoodConnection(const int numNodes, const Genome& genome) {
